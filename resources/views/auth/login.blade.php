...
<head>
    ...
    <meta charset="utf-8" />
    <meta name="description" content="ProTrack - Project Tracking System" />
    <meta name="keywords" content="protrack, project, tracking, construction" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta property="og:locale" content="id_ID" />
    <meta property="og:type" content="article" />
    <meta property="og:title" content="ProTrack - Project Tracking System" />
        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
            ...
            <div class="d-flex flex-lg-row-fluid">
                ...
                <div class="d-flex flex-column flex-center p-10 w-100">
                    ...
                    <h1 class="text-gray-800 fs-2qx fw-bold text-center mb-7">Welcome to ProTrack</h1>
                    ...
                    <div class="w-md-400px">
                        ...
                        <form class="form w-100" id="kt_sign_in_form" method="POST"
                            ...
                            <div class="text-center mb-11">
                                ...
                                <div class="text-gray-500 fw-semibold fs-6">ProTrack — Project Tracking System
                                </div>
                            </div>
                            <!--end::Heading-->
