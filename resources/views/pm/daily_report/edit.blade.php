            ...
            <div class="card-body">
                <div class="row g-4">
                    <div class="col-md-4">
                        ...
                        <input type="date" name="report_date" id="report_date" class="form-control" value="{{ old('report_date', $dailyReport->report_date) }}" @if($project->start_date) min="{{ $project->start_date }}" @endif @if($project->end_date) max="{{ $project->end_date }}" @endif required>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label" for="kegiatan">Kegiatan</label>
                        <input type="text" name="kegiatan" id="kegiatan" class="form-control" value="{{ old('kegiatan', $dailyReport->kegiatan) }}" placeholder="Kegiatan">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label" for="lokasi_kegiatan">Lokasi Kegiatan</label>
                        <input type="text" name="lokasi_kegiatan" id="lokasi_kegiatan" class="form-control" value="{{ old('lokasi_kegiatan', $dailyReport->lokasi_kegiatan) }}" placeholder="Lokasi">
                    </div>
                    <div class="col-12">
                        <label class="form-label" for="rincian_kegiatan">Rincian Kegiatan</label>
                        <input type="text" name="rincian_kegiatan" id="rincian_kegiatan" class="form-control" value="{{ old('rincian_kegiatan', $dailyReport->rincian_kegiatan) }}" placeholder="Rincian kegiatan">
                    </div>
                    <div class="col-md-4">
